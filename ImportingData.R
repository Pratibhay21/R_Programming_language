...
# CSV
rio_csv <- import("C:/Users/user/Downloads/mbb.csv") #use '/' for path else will show error
head(rio_csv)

# TXT
rio_txt <- import("C:/Users/user/Downloads/mbb.txt")
head(rio_txt)

# Excel XLSX
rio_xlsx <- import("C:/Users/user/Downloads/mbb.xlsx")
head(rio_xlsx)
...
# complete data.
r_txt1 <- read.table("C:/Users/user/Downloads/mbb.txt", header = TRUE)

# This works with missing data by specifying the separator: 
# \t is for tabs, sep = "," for commas. R converts missing
# to "NA"
r_txt2 <- read.table("C:/Users/user/Downloads/mbb.txt", 
  header = TRUE, 
  sep = "\t")
...
trends.csv <- read.csv("C:/Users/user/Downloads/mbb.csv", header = TRUE)
